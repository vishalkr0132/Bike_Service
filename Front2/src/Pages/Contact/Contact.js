                    ...
                    <div class="col-md-6">
                      <div class="form-input mt-15">
                        ...
                        <div class="input-items default">
                          ...
                          <input type="text" placeholder="vishal kumar" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-input mt-15">
                        ...
                        <div class="input-items default">
                          ...
                          <input
                            type="text"
                            placeholder="vishalkumar.itcs@gmail.com"
                          />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-input mt-15">
                        ...
                        <div class="input-items default">
                          ...
                          <input type="text" placeholder="+91 7991198925" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                ...
                <ul class="info">
                  ...
                  <li>
                    <div class="single-info">
                      ...
                      <div class="info-content">
                        <p class="text">vishalkumar.itcs@gmail.com</p>
                      </div>
                    </div>
                  </li>
                </ul>
